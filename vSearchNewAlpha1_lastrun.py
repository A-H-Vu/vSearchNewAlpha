...
expName = 'vSearchNewAlpha1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\vSearchNewAlpha\\vSearchNewAlpha1_lastrun.py',
...
for thisTaskLoop in taskLoop:
    ...
    elif condsFile == "vSearch2Cond.xlsx":
    ...
    elif condsFile == "vSearchCond.xlsx":
        instrText.text = "A quick break before the next set of trials. Remember, only press the ‘s’ key if you see the upright “T” shape, which is the last shape below. Otherwise, press the ‘k’ key. There will be 6, 12, or 18 shapes to observe in each trial. Press ‘space’ to continue."
    else: 
        instrText.text = "A quick break before the next set of trials. Remember, only press the ‘s’ key if you see the upright “T” shape, which is the last shape below. Otherwise, press the ‘k’ key. There will be 6, 12, or 18 shapes to observe in each trial. Press ‘space’ to continue."
    instrResp.keys = []
    ...
    taskLoop.addData('l1ex.started', l1ex.tStartRefresh)
    taskLoop.addData('l1ex.stopped', l1ex.tStopRefresh)
    taskLoop.addData('l2ex.started', l2ex.tStartRefresh)
    taskLoop.addData('l2ex.stopped', l2ex.tStopRefresh)
    taskLoop.addData('t1ex.started', t1ex.tStartRefresh)
    taskLoop.addData('t1ex.stopped', t1ex.tStopRefresh)
    taskLoop.addData('tTex.started', tTex.tStartRefresh)
    taskLoop.addData('tTex.stopped', tTex.tStopRefresh)
    ...
    for thisTrialsLoop in trialsLoop:
        ...
        trialsLoop.addData('trialL11.started', trialL11.tStartRefresh)
        trialsLoop.addData('trialL11.stopped', trialL11.tStopRefresh)
        trialsLoop.addData('trialL12.started', trialL12.tStartRefresh)
        trialsLoop.addData('trialL12.stopped', trialL12.tStopRefresh)
        trialsLoop.addData('trialL21.started', trialL21.tStartRefresh)
        trialsLoop.addData('trialL21.stopped', trialL21.tStopRefresh)
        trialsLoop.addData('trialL22.started', trialL22.tStartRefresh)
        trialsLoop.addData('trialL22.stopped', trialL22.tStopRefresh)
        trialsLoop.addData('trialT11.started', trialT11.tStartRefresh)
        trialsLoop.addData('trialT11.stopped', trialT11.tStopRefresh)
        trialsLoop.addData('trialT12.started', trialT12.tStartRefresh)
        trialsLoop.addData('trialT12.stopped', trialT12.tStopRefresh)
        trialsLoop.addData('trialL13.started', trialL13.tStartRefresh)
        trialsLoop.addData('trialL13.stopped', trialL13.tStopRefresh)
        trialsLoop.addData('trialL14.started', trialL14.tStartRefresh)
        trialsLoop.addData('trialL14.stopped', trialL14.tStopRefresh)
        trialsLoop.addData('trialL23.started', trialL23.tStartRefresh)
        trialsLoop.addData('trialL23.stopped', trialL23.tStopRefresh)
        trialsLoop.addData('trialL24.started', trialL24.tStartRefresh)
        trialsLoop.addData('trialL24.stopped', trialL24.tStopRefresh)
        trialsLoop.addData('trialT13.started', trialT13.tStartRefresh)
        trialsLoop.addData('trialT13.stopped', trialT13.tStopRefresh)
        trialsLoop.addData('trialT14.started', trialT14.tStartRefresh)
        trialsLoop.addData('trialT14.stopped', trialT14.tStopRefresh)
        trialsLoop.addData('trialL15.started', trialL15.tStartRefresh)
        trialsLoop.addData('trialL15.stopped', trialL15.tStopRefresh)
        trialsLoop.addData('trialL16.started', trialL16.tStartRefresh)
        trialsLoop.addData('trialL16.stopped', trialL16.tStopRefresh)
        trialsLoop.addData('trialL25.started', trialL25.tStartRefresh)
        trialsLoop.addData('trialL25.stopped', trialL25.tStopRefresh)
        trialsLoop.addData('trialL26.started', trialL26.tStartRefresh)
        trialsLoop.addData('trialL26.stopped', trialL26.tStopRefresh)
        trialsLoop.addData('trialT15.started', trialT15.tStartRefresh)
        trialsLoop.addData('trialT15.stopped', trialT15.tStopRefresh)
        trialsLoop.addData('trialT16.started', trialT16.tStartRefresh)
        trialsLoop.addData('trialT16.stopped', trialT16.tStopRefresh)
        trialsLoop.addData('trialTT.started', trialTT.tStartRefresh)
        trialsLoop.addData('trialTT.stopped', trialTT.tStopRefresh)
        # check responses
        ...
        trialsLoop.addData('trialResp.corr', trialResp.corr)
